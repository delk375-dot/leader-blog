 ...
 * - Pillar articles are canonical knowledge-base assets and should be visible
 *   immediately once committed
 * - In production, excludes scheduled non-pillar posts until `pubDatetime`
...
export function postFilter({ data }: CollectionEntry<"posts">) {
  ...
  if (data.contentType === "pillar_article") return true;
